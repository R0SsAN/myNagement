...
$sql = "SELECT * FROM prodotti_da_vendere WHERE CodAzienda='" . $_SESSION['aziendaId'] . "'";
if ($result = mysqli_query($link, $sql)) {
  ...
  <button class="buttonanagraficamin" id="btn2">ELIMINA PRODOTTI</button>   
    ...
    <span class="close">&times;</span>
       ...
       <div class="rowin" style="padding-top: 3%">
       <div class="column">
       <p>Seriale:</p> <input name="Seriale" type="text"><br>
       <p>Nome:</p> <input  name="Nome" type="text"><br>       
       </div>
       <div class="column">
       <p>Quantità:</p> <input name="Quantita" style="width: 45%; text-align: center" type="number" value="1" min=1 max = 50000><br>
       <p>Prezzo:</p> <input type="range" name="Prezzo" value="1" min="1" max="50000" oninput="this.nextElementSibling.value = this.value">
       <input type="number" max=50000 style="text-align: center; margin-left: 5%" oninput="this.previousElementSibling.value = this.value" value="1" min=1>$
       </div>
       </div>
     ...
     <form id="deletef" method=POST action="elimina_in_vendita.php" class="modal-content-minor">
