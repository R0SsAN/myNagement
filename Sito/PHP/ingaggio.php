...
if (isset($_POST["tipo"])) {
    ...
    if ($_POST["tipo"] == "ingaggio") {
        ...
        if (
            isset($_POST["nome"]) && isset($_POST["cognome"]) && isset($_POST["telefono"]) && isset($_POST["email"]) && isset($_POST["indirizzo"]) && isset($_POST["cf"]) && isset($_POST["mansione"]) &&
            isset($_POST["orario"]) && isset($_POST["salario"]) && isset($_POST["tipoContratto"]) && isset($_POST["dataInizio"]) && isset($_POST["nascita"]) && isset($_POST["rfid"])
        ) {
            ...
            if ($result = $link->query($query)) {
                ...
                if ($result = $link->query($query)) {
                    ...
                    if ($_POST["dataFine"] == "")
                        $query = "INSERT INTO contratti(Salario, OreLavorative, DataInizio, DataFine, CodDipendente, RFID) 
                                VALUES ('" . $_POST["salario"] . "', '" . $_POST["orario"] . "', '" . $_POST["dataInizio"] . "', NULL, '" . $cod . "','" . $_POST["rfid"] . "')";
                    else
                        $query = "INSERT INTO contratti(Salario, OreLavorative, DataInizio, DataFine, CodDipendente, RFID) 
                                VALUES ('" . $_POST["salario"] . "', '" . $_POST["orario"] . "', '" . $_POST["dataInizio"] . "', '" . $_POST["dataFine"] . "', '" . $cod . "','" . $_POST["rfid"] . "')";
                    if ($result = $link->query($query)) {
                        die("true");
                    }
